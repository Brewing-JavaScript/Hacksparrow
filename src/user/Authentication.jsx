...
const Authentication = () => {
    ...
    return (
        <div style={{backgroundColor: "#0c0c0c"}} className="min-h-screen flex justify-center items-center bg-gray-200">
            <div className="text-white p-8 rounded-lg shadow-md" style={{width: "45%"}}>
                {/* <h2 className="text-2xl font-semibold mb-4 text-center">Welcome to CampusConnect</h2> */}
                {isSignUp? (
                    <div>
                    <h2 style={{fontSize: "3rem"}} className="mt-4 font-bold leadiF">Welcome to WebNews</h2>
                    <h2 style={{fontSize: "2rem", fontSize: "1.5rem", lineHeight: 1, marginBottom: "2rem", color: "gray"}}>Create an account</h2>
                    </div>
                ): 
                <div>
                    <h2 style={{fontSize: "3rem"}} className="mt-4 font-bold leadiF">Log in to your account</h2>
                    <h2 style={{fontSize: "2rem", fontSize: "1.5rem", lineHeight: 1, marginBottom: "2rem", color: "gray"}}>Please enter your details</h2>
                </div>}
